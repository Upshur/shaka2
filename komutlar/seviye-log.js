...
exports.conf = {
  enabled: true,  
  guildOnly: false, 
  aliases: ["seviye-kanal" , "seviyekanal" , "seviyelog" , "seviye-log"], 
  permLevel: 0
};
